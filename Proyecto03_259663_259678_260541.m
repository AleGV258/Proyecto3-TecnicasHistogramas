...
Obscura1CorreccionRadiometrica = TecnicasHistograma(IObscura1, 4, "Primera Imagen Obscura", valmaxObscura, kObscura, tipoObscura, cObscura, bObscura, mObscura, valIniObscura, valFinObscura); %% Imagen Obscura 1 con Técnica de Corrección Radiométrica
...
Obscura2CorreccionRadiometrica = TecnicasHistograma(IObscura2, 4, "Segunda Imagen Obscura", valmaxObscura, kObscura, tipoObscura, cObscura, bObscura, mObscura, valIniObscura, valFinObscura); %% Imagen Obscura 2 con Técnica de Corrección Radiométrica
...
Contraste1CorreccionRadiometrica = TecnicasHistograma(IContraste1, 4, "Primera Imagen Contraste", valmaxContraste, kContraste, tipoContraste, cContraste, bContraste, mContraste, valIniContraste, valFinContraste); %% Imagen Contraste 1 con Técnica de Corrección Radiométrica
...
Contraste2CorreccionRadiometrica = TecnicasHistograma(IContraste2, 4, "Segunda Imagen Contraste", valmaxContraste, kContraste, tipoContraste, cContraste, bContraste, mContraste, valIniContraste, valFinContraste); %% Imagen Contraste 2 con Técnica de Corrección Radiométrica
...
Clara1CorreccionRadiometrica = TecnicasHistograma(IClara1, 4, "Primera Imagen Clara", valmaxClara, kClara, tipoClara, cClara, bClara, mClara, valIniClara, valFinClara); %% Imagen Clara 1 con Técnica de Corrección Radiométrica
...
Clara2CorreccionRadiometrica = TecnicasHistograma(IClara2, 4, "Segunda Imagen Clara", valmaxClara, kClara, tipoClara, cClara, bClara, mClara, valIniClara, valFinClara); %% Imagen Clara 2 con Técnica de Corrección Radiométrica
