...
valmax = 255; %% Valor máximo posible
k = 0.00035; %% Constante de escalamiento
tipo = 1; %% Tipo de escalamiento lineal
c = 1.7; %% Constante de contraste
b = 50; %% Constante de brillo
m = 2; %% Exponente
valIni = 100; %% Rango inicial
valFin = 200; %% Rango final
